...
from .dataset import JinaRerankerM0TrainDataset, JinaRerankerM0Collator
from .load_model import get_model, save_merged_model

logger = logging.getLogger(__name__)


class JinaRerankerM0Runner(AbsRerankerRunner):
    """Runner class for jina-reranker-m0 training.
    ...
    def __init__(
        ...
        self.model_args: JinaRerankerM0ModelArguments
    ...
    def load_train_dataset(self):
        ...
        self.train_dataset = JinaRerankerM0TrainDataset(
            args=self.data_args,
    ...
    def load_data_collator(self):
        ...
        self.data_collator = JinaRerankerM0Collator(
            tokenizer=self.tokenizer,
    ...
    def load_trainer(self) -> JinaRerankerM0Trainer:
        """Load the trainer.

        Returns:
            Loaded trainer instance.
        """
        trainer = JinaRerankerM0Trainer(
            model=self.model,
            args=self.training_args,
            train_dataset=self.train_dataset,
            data_collator=self.data_collator,
            # Don't pass processing_class: the Qwen2VL fast tokenizer triggers
