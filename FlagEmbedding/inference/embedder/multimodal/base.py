...
class MultimodalMLLMEmbedder(AbsEmbedder):
    ...
    def encode_single_device(
        ...
        **kwargs: Any
        ...
        """Encode input sentences and/or images by a single device.
        ...
        # Check if the model has data_process method (multimodal model)
        if hasattr(self.model, 'data_process'):
            ...
            # Text-only model processing (original implementation)
            input_was_string = False
