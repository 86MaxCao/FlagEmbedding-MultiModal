...
class MultimodalEmbedderRunner(AbsEmbedderRunner):
    """Runner class for multimodal embedding model.
    ...
    def __init__(
        ...
        self.model_args: MultimodalEmbedderModelArguments
    ...
    def load_trainer(self) -> MultimodalEmbedderTrainer:
        ...
        Returns:
            MultimodalEmbedderTrainer: Loaded trainer instance.
        """
        trainer = MultimodalEmbedderTrainer(
            model=self.model,
