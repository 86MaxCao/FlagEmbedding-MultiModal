...
from FlagEmbedding.finetune.reranker.decoder_only.qwen3.arguments import Qwen3RerankerModelArguments
...
def get_model(model_args: Qwen3RerankerModelArguments):
    """Get the model."""
...
def save_merged_model(model_args: Qwen3RerankerModelArguments, output_dir: str):
