...
# MMEB-train Embedder Evaluation Script
# For evaluating BAAI/BGE-VL-MLLM-S1 or other multimodal embedders on MMEB-train dataset
...
if [ "$QUICK_TEST" = "true" ]; then
    ...
    eval_args="\
        ...
        --eval_output_path ./mmeb_train/embedder_eval_results.md \
...
echo "Running MMEB-train Embedder Evaluation..."
echo $cmd
eval $cmd
